 ...
 * @see https://v0.dev/t/AGnpr3fcnCr
 */
          ...
          <div className="flex items-center justify-center p-6">
            <div className="grid gap-2 w-full sm:gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select className="min-h-[8rem] max-h-[12rem] appearance-none" id="purchases" multiple>
                  <option>One-time purchase</option>
                  <option>Monthly subscription</option>
                  <option>Annual subscription</option>
                  <option>Lifetime access</option>
                  <option>Freemium user</option>
                </Select>
              </div>
              <div className="space-y-2">
                <Label htmlFor="message">Message</Label>
                <Textarea className="min-h-[8rem] max-h-[12rem]" id="message" placeholder="Enter your message" />
              </div>
              <Button type="submit">
      ...
      <div className="flex flex-col border-t md:border-t-0 md:border-l">
        <div className="flex-1">
          <div className="p-6 grid gap-4">
            <div className="space-y-2">
              <h3 className="text-lg font-medium tracking-wide sm:text-xl md:text-2xl">Purchase History</h3>
              <p className="text-sm leading-loose text-gray-500 md:text-base dark:text-gray-400">
                You can select multiple options.
              </p>
            </div>
            <div className="space-y-2">
              <h3 className="text-lg font-medium tracking-wide sm:text-xl md:text-2xl">Message</h3>
              <p className="text-sm leading-loose text-gray-500 md:text-base dark:text-gray-400">
